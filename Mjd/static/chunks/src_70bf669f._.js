...
const useAuth = ()=>{
    ...
    const [isProUser, setIsProUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
        ...
        "useAuth.useEffect": ()=>{
            if (user && firestore) {
                ...
                const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(userDocRef, {
                    "useAuth.useEffect.unsubscribe": (docSnap)=>{
...
_s2(useAuth, "BcjY2wPZ7VPbdRzqAP5IS8hHhfw=", false, function() {
    return [
        useFirebase
    ];
});
...
_s3(useFirestore, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
...
const useAdmin = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAdmin.useEffect": ()=>{
            if (user && db) {
                const adminDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(db, 'admins', user.uid);
                const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(adminDocRef, {
                    "useAdmin.useEffect.unsubscribe": (docSnap)=>{
                        setIsAdmin(docSnap.exists());
                        setIsCheckingAdmin(false);
                    }
                }["useAdmin.useEffect.unsubscribe"], {
                    "useAdmin.useEffect.unsubscribe": ()=>{
                        setIsAdmin(false);
                        setIsCheckingAdmin(false);
                    }
    ...
    const makeAdmin = async ()=>{
        if (user && db) {
            const adminDocRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["doc"])(db, 'admins', user.uid);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["setDoc"])(adminDocRef, {
                isAdmin: true
            });
            setIsAdmin(true);
        }
...
_s7(useAdmin, "RklCE6jcnoVHkjwdfxxYK66UQvw=", false, function() {
    return [
        useAuth,
        useFirestore
    ];
...
function ClientLayout({ children }) {
    _s();
    const [services, setServices] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(null);
    ...
    }["ClientLayout.useEffect"], []); // Empty dependency array ensures this runs only once on mount.
    if (!services) {
...
_s(ClientLayout, "EtqJBMMCfged1IUmg+kuIketvTg=");
_c = ClientLayout;
var _c;
...
//# sourceMappingURL=src_70bf669f._.js.map