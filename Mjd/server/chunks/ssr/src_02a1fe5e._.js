...
"[project]/src/lib/popular-data.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/hardcoded-translations.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/matchStatus.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/local-favorites.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$favorites$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/local-favorites.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
const handleNewUser = async (user, firestore)=>{
    ...
    const favoritesRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["doc"])(firestore, 'users', user.uid, 'favorites', 'data');
    const localFavorites = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$favorites$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getLocalFavorites"])();
    ...
    try {
        ...
        if (userDoc.exists()) {
            ...
            if (hasLocalFavorites) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setDoc"])(favoritesRef, localFavorites, {
                    merge: true
                });
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$favorites$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["clearLocalFavorites"])();
            }
...
const signOut = ()=>{
    if ("undefined" !== 'undefined' && localStorage.getItem(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$favorites$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["GUEST_MODE_KEY"])) {
        "TURBOPACK unreachable";
    }
...
const updateUserDisplayName = async (user, newDisplayName, db)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateDoc"])(userRef, userProfileUpdateData).catch((serverError)=>{
        const permissionError = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$errors$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["FirestorePermissionError"]({
            path: userRef.path,
            operation: 'update',
...
"[project]/src/lib/revenuecat-client.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_02a1fe5e._.js.map